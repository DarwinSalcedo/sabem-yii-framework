  ...
  <div class="span3 ">
    <div class="stat-block">
      <ul>
        ...
        <li class="stat-percent"><a class="brand" href="#"><span class="text-success stat-percent">Ir</span></a></li>
      </ul>
    </div>
  </div>
  <div class="span3 ">
    <div class="stat-block">
      <ul>
        ...
        <li class="stat-percent"><a class="brand" href="<?php echo yii::app()->createUrl('usuario/datos'); ?>"><span class="text-success stat-percent">Ir</span></a></li>
      </ul>
    </div>
  </div>
  <div class="span3 ">
  ...
  <div class="span3 ">
    <div class="stat-block">
      <ul>
        ...
        <li class="stat-percent"><a class="brand" href="<?php echo yii::app()->createUrl("/Funcionarios/saludo");?>"><span><span class="text-success stat-percent">Ir</span></a></li>
      </ul>
    </div>
  </div>
</div>
		...
		<div class="summary">
          <ul>
          	<li>
                ...
                <span class="summary-number">Octubre 15</span>
            ...
            <li>
                ...
                <span class="summary-number">Diciembre 12</span>
