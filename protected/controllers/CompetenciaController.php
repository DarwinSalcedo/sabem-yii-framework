...
class CompetenciaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{$evaluador=new Evaluador;
			$CedEvaluador=$_POST['Competencia']['id_evaluador'];
			$id = $evaluador->buscarUltimo();
			$_POST['Competencia']['id_evaluador']=$id;
		   # var_dump($_POST['Competencia']);
		#    yii::app()->end();
		    $evaluador->guardar($id,
		    	$cedula = $_POST['Competencia']['Cedula'],
		    	$CedEvaluador,
		    	$fecha = $_POST['Competencia']['id_conf_asc_fecha']);
			$model->attributes=$_POST['Competencia'];
			if($model->save()){
				$alerta= new alerta;
				$alerta->generar('Competencia',$cedula);
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Competencia']))
		{
			$model->attributes=$_POST['Competencia'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_competencia));
		}
	 ...
	 * @param Competencia $model the model to be validated
	 */
